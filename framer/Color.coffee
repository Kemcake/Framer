  ...
  #  - rgb(a) array [255,140,20,0.5] -- alpha optional
	...
	constructor: (options) ->
		if typeof options == "string"
			if @_cssColors[options]
				@_colorFromHex @_cssColors[options]
				return
